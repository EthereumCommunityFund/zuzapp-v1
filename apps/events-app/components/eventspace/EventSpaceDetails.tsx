...
const EventSpaceDetails: React.FC<EventSpaceDetailsProps> = ({ eventSpace }) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      end_date: end_date as unknown as Date,
      description,
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <div className="flex flex-col gap-[14px] items-start self-stretch w-full">
                      ...
                      <CustomDatePicker selectedDate={start_date !== undefined ? new Date(start_date) : new Date()} handleDateChange={field.onChange} {...field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <div className="flex flex-col gap-[14px] items-start self-stretch w-full">
                      ...
                      <CustomDatePicker selectedDate={end_date !== undefined ? new Date(end_date) : new Date()} handleDateChange={field.onChange} {...field} />
                      <h3 className="opacity-70 h-3 font-normal text-[10px] leading-3">Click & Select or type in a date</h3>
                      <FormMessage />
                    </div>
                  )}
