...
export default function DashboardNavigation() {
  ...
  return (
    <>
      ...
      ></div>
      <nav
        className={`dashboard-menu min-w-[260px] z-10 fixed flex flex-col h-screen border-r border-r-gray-800 bg-[#2F3232] py-16 px-6 transition-transform duration-300 ${dashboardOpen && "open"
          }`}
      >
