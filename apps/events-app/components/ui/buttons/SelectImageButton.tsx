...
export default function SelectImageButton(props: IProps) {
  return (
    <Button variant="light-dark" className="flex flex-col py-[100px] px-3 gap-[10px] self-stretch rounded-[6px] border-dashed border-white border-opacity-10 bg-inputField h-full">
      <HiUpload />
