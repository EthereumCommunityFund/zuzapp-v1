      ...
      <div className="flex flex-col items-center gap-8 self-stretch rounded-2xl">
        <div className="flex flex-col items-center gap-[34px] self-stretch w-full text-white">
          ...
          {scheduleUpdated ? (
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10 w-full text-white">
                <FormField
                  control={form.control}
                  name="format"
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel className="text-2xl opacity-80 leading-[1.2] text-white/80 font-bold">Schedule Format</FormLabel>
