...
export default function EditScheduleForm({
  ...
  const track_title = eventSpace?.tracks.find((track) => track.id === trackId)
    ?.name;
  ...
  const handleEnterEventViewSessions = () => {
    ...
    try {
      router.push({
        pathname: isQuickAccess
          ? `/dashboard/eventview/allschedules`
          : `/dashboard/eventview/tracks/track`,
        query: {
                ...
                <Form {...form}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-[14px] items-start w-full">
                        <Label className="text-lg font-semibold text-whit">
