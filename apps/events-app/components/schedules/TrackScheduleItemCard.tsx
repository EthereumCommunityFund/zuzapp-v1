...
import { sortSchedulesByStartTime, stringToDateFormated, toTurkeyTime } from '@/utils';
                  ...
                  <div className="flex flex-col items-start gap-[10px]">
                    ...
                    <div className="flex items-start self-stretch text-sm gap-6">
                      <span className="flex items-center p-1 gap-1 rounded-[10px] opacity-60 bg-[#FFFFFF10] white-space-nowrap overflow-hidden text-ellipsis">
                        ...
                        <span className="ml-2 text-xs md:text-sm ">{stringToDateFormated(schedule?.start_date)}</span>
                      </span>
                      <span className="flex items-center p-1 gap-1 rounded-[10px] opacity-60 bg-[#FFFFFF10] white-space-nowrap overflow-hidden text-ellipsis">
                        <BiTimeFive size={30} />
                        <span className="ml-2 text-xs md:text-sm ">
                          {schedule?.start_time} - {toTurkeyTime(schedule?.end_time).format('H:mm')}
                        </span>
                      </span>
                    </div>
                  </div>
