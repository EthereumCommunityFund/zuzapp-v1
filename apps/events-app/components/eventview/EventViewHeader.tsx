...
export default function EventViewHeader(props: IEventViewHeader) {
  ...
  return (
    <div className={"flex md:px-10 gap-[10px] lg:rounded-full lg:h-[60px] justify-between items-center lg:bg-inherit lg:backdrop-blur-none sm:backdrop-blur-sm lg:relative md:flex-row sm:fixed sm:bottom-0 sm:bg-white/10 sm:flex-col w-full sm:z-[1000] lg:z-50"}>
