...
export default function UserProfile(props: any) {
  const { profile } = props;
  return (
    <div className='lg:px-40 sm:px-0 flex min-w-[900px] w-full lg:flex-row sm:flex-col'>
      ...
      <div className='lg:pt-10 sm:pt-3 lg:px-[30px] pb-40 lg:rounded-[10px] flex flex-col gap-5 w-full'>
        <Label className="text-xl md:hidden lg:flex">Your Profile</Label>
        <div className='px-4 py-5 bg-componentPrimary lg:rounded-2xl flex flex-col gap-5 min-w-[900px] border border-borderPrimary'>
          {/* Avatar */}
          ...
          <div className="gap-2.5 pb-5 flex flex-col border-b">
            ...
            <textarea placeholder="Received the title of Big Boss" className='text-white py-3 px-2 placeholder-[#AAAAAA] bg-inputField outline-none rounded-[8px] text-sm border border-borderPrimary' />
          </div>
          {/* Display Name */}
          <div className="gap-2.5 pb-5 flex flex-col border-b">
            ...
            <Input type="text" placeholder={profile[0].username} className='text-white py-3 px-2 placeholder-[#AAAAAA] bg-inputField outline-none rounded-[8px] text-sm border border-borderPrimary' />
          </div>
          <div className="flex justify-end">
            <Button size="lg" leftIcon={FaCircleArrowDown} className='w-44 rounded-xl justify-center md:text-base sm:text-sm'>Save Changes</Button>
          </div>
        </div>
      </div>
    </div>
