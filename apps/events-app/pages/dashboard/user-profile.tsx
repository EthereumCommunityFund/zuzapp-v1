      ...
      {isProfileUpdated ? (
        <>
          <div className="flex flex-col w-full items-center justify-center">
            ...
            <Button onClick={handleEnterHomePage} variant="primary" className="mt-8 bg-[#67DBFF]/20 text-[#67DBFF] rounded-full" leftIcon={HiArrowRight}>
              Go to HomePage
            </Button>
          </div>
        </>
          ...
          {profile && (
            <>
              <div className="pt-5 rounded-[10px] flex lg:flex-col sm:flex-row gap-2.5 lg:items-start items-center">
                <Button variant="quiet-SM" className="text-xl lg:text-base" leftIcon={ArrowLeft}>
                  Back
                </Button>
              ...
              <div className="lg:pt-10 sm:pt-3 lg:px-[30px] pb-40 lg:rounded-[10px] flex flex-col gap-5 w-full">
                ...
                <div className="px-4 py-5 bg-componentPrimary lg:rounded-2xl flex flex-col gap-5 lg:min-w-[900px] border border-borderPrimary sm:w-full">
                  ...
                  <div className="flex justify-end">
                    <Button size="lg" leftIcon={FaCircleArrowDown} className="w-44 rounded-xl justify-center md:text-base sm:text-sm" onClick={handleUpdateUserProfile}>
                      Save Changes
                    </Button>
                  </div>
                </div>
