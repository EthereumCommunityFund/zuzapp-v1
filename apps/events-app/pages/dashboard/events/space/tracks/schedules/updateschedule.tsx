                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      ...
                      <FormControl>
                        <RadioGroup onValueChange={handleEventFormatChange} defaultValue={field.value} className="flex flex-col md:flex-row justify-between">
              ...
              <div className="flex flex-col gap-6 items-start self-stretch">
                ...
                <div className="flex gap-2.5 items-center rounded-[8px] px-2 py-1.5 bg-white bg-opacity-10">
                  <button className="flex gap-2.5 items-center">
                    ...
                    <InputFieldLabel name={'Janine Leger'} />
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-6 self-stretch">
              ...
              <div className="flex items-start gap-[10px]">
                <div className="flex gap-2.5 items-center rounded-[8px] px-2 py-1.5 bg-white bg-opacity-10">
                  <button className="flex gap-2.5 items-center">
                    <GoXCircle className="top-0.5 left-0.5 w-4 h-4" />
                    <InputFieldLabel name={'TagOne'} />
                  </button>
                </div>
                <div className="flex gap-2.5 items-center rounded-[8px] px-2 py-1.5 bg-white bg-opacity-10">
                  <button className="flex gap-2.5 items-center">
                    <GoXCircle className="top-0.5 left-0.5 w-4 h-4" />
                    <InputFieldLabel name={'TagTwo'} />
                  </button>
                </div>
              </div>
            </div>
