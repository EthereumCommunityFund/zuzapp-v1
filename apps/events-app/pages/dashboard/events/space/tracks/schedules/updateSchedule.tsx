...
export default function UpdateSchedulePage() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      end_date: schedule.end_date !== undefined && schedule.end_date !== null ? new Date(schedule.end_date) : new Date(),
      description: '',
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    if (frequency === 'everyday' || frequency === 'weekly') {
      const endDate = fromTurkeyToUTC(values.end_date).toDate().setHours(0, 0, 0, 0);
      const startDate = fromTurkeyToUTC(values.date).toDate().setHours(0, 0, 0, 0);
    ...
    const additionalPayload = {
      ...
      end_date: fromTurkeyToUTC(schedule.end_date).toDate().setHours(0, 0, 0, 0),
                ...
                <DialogHeader>
                  ...
                  <DialogFooter className="pt-5">
                    <div className="flex justify-between items-center">
                      <button
                        onClick={form.handleSubmit(onSubmitWithEnter)}
