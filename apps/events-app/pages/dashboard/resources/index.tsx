...
export default function Resources() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* PlayBook Header */}
      <div className="pt-5 px-10 pb-10 flex flex-col gap-5">
      ...
      <div className="pt-5 px-10 pb-10 flex flex-col gap-5">
        ...
        {isAuthenticated && profile ? (
          ...
          <div className="flex flex-col gap-2.5">
            <div className="p-5 bg-componentPrimary rounded-2xl border Open Source Ops Playbook border-borderPrimary">
