  ...
  return (
    <div className="about_container">
      ...
      <p>
        ...
        <span className="highlighted_p"> Crypto Cities</span>. Over time the
        idea manifested to an experiment with the first iteration being: Zuzalu
        Montenegro. The goal: Create a pop-up city that houses 200+ people from
        a diverse variety of regions and fields together for 2 whole months
        aimed to blend a variety of cultures fostering an environment where
        innovative experiments could make positive impacts on the world. To
        learn more about the idea behind Zuzalu,
      ...
      <div className="container_box">
        ...
        <p>
          ...
          <span className="highlighted_p">should be neutral</span>, and in such
          a way that anyone can see that it is neutral even if they do not
