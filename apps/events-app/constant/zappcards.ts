...
export const zAppCards: ZappCardTemplate[] = [
  {
    ...
    appDescription: "The ultimate conversational chatbot for Zuzaluans!",
  ...
  },
  {
    ...
    appTitle: "ZuPoll",
    appDescription: "Create & participate in anonymous polls with ZuPass",
  ...
  },
  {
    ...
    appTitle: "ZuCast",
    appDescription: "An anonymous forum designed for the Zuzalu community.",
